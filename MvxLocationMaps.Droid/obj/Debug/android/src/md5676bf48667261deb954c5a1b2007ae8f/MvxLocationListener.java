package md5676bf48667261deb954c5a1b2007ae8f;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Plugins.Location.Droid.MvxLocationListener, MvvmCross.Plugins.Location.Droid, Version=4.0.0.0, Culture=neutral, PublicKeyToken=null", MvxLocationListener.class, __md_methods);
	}


	public MvxLocationListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MvxLocationListener.class)
			mono.android.TypeManager.Activate ("MvvmCross.Plugins.Location.Droid.MvxLocationListener, MvvmCross.Plugins.Location.Droid, Version=4.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
